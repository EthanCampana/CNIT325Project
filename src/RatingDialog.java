...
public class RatingDialog extends javax.swing.JDialog {
    ...
    int Finalrating = 0;
    URL iconUrl = getClass().getResource("Photo/Star 2.png");
    Toolkit tk = getToolkit();
    ImageIcon logo = new ImageIcon(tk.getImage(iconUrl));
    ...
    private void star1MouseClicked(java.awt.event.MouseEvent evt) {
        rating = 1;
        star1.setEnabled(true);
        star2.setEnabled(false);
        star3.setEnabled(false);
    ...
    private void star2MouseClicked(java.awt.event.MouseEvent evt) {
        rating = 2;
        star1.setEnabled(true);
        star2.setEnabled(true);
        star3.setEnabled(false);
    ...
    private void star3MouseClicked(java.awt.event.MouseEvent evt) {
        rating = 3;
        star1.setEnabled(true);
        star2.setEnabled(true);
        star3.setEnabled(true);
    ...
    private void star4MouseClicked(java.awt.event.MouseEvent evt) {
        rating = 4;
        star1.setEnabled(true);
        star2.setEnabled(true);
        star3.setEnabled(true);
    ...
    private void star5MouseClicked(java.awt.event.MouseEvent evt) {
        rating = 5;
        star1.setEnabled(true);
        star2.setEnabled(true);
        star3.setEnabled(true);
